...
# 1. SETUP CONSTANTS
PC_IP = "192.168.1.3"  # <--- CHANGE THIS to your actual PC IP
PORT = 65432
...
def open_pc_site(url: str):
    ...
    Use this when the user asks to 'open' a site, 'search' for something, or 'go to' a URL.
    """
